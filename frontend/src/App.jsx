    ...
    <AuthProvider>
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/bookings" element={<Layout><ProtectedRoute allowedRoles={['customer', 'owner']}><BookingList /></ProtectedRoute></Layout>} />
          <Route path="/owner/cars/new" element={<Layout><ProtectedRoute allowedRoles={['owner']}><AddCar /></ProtectedRoute></Layout>} />
          <Route path="/owner/cars/:id/edit" element={<Layout><ProtectedRoute allowedRoles={['owner']}><EditCar /></ProtectedRoute></Layout>} />
          <Route path="/customer/dashboard" element={<Layout><ProtectedRoute allowedRoles={['customer']}><CustomerDashboard /></ProtectedRoute></Layout>} />
